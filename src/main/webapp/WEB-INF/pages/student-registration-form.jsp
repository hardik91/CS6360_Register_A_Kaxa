...
<html>
        ...
        <div class="register">
          ...
          <form id="reg-form">
            <div>
              ...
              <input type="text" id="name" spellcheck="false" placeholder="Name"/>
            </div>
              <div>
 ...
 <div>
              ...
              <input type="text" id="addr" spellcheck="false" placeholder="Address"/>
            </div>
              
              <div>
              <label for="email">Email</label>
              <input type="text" id="email" spellcheck="false" placeholder="Email Address"/>
            </div>
              
            <div>
              <label for="username">Username</label>
              <input type="text" id="username" spellcheck="false" placeholder="Username" />
            </div>
            <div>
